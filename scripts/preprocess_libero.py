...
def get_task_embs(cfg, descriptions):
    ...
    """
    # Debug: Check if descriptions is empty
    if not descriptions:
        raise ValueError("No task descriptions provided")
    print("Task descriptions:", descriptions)  # Debug statement
    ...
    if cfg.task_embedding_format == "bert":
        ...
        # Debug: Print before tokenizing
        print("Tokenizing descriptions:", descriptions)
        ...
        # Debug: Check the generated tokens
...
def get_task_bert_embs(libero_root_dir):
    ...
    # Debug: Check task names
    print("Task names extracted:", task_names)
